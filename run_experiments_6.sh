...
# MARL experiment batch 6: IQL team_reward shared variants (no baseline) + QMIX shared variants
# iql_team_reward_doubleq_shared, iql_team_reward_dueling_shared,
# iql_team_reward_dueling_doubleq_shared,
# qmix_shared, qmix_doubleq_shared, qmix_dueling_shared, qmix_dueling_doubleq_shared
...
run_root="${OUTPUT_ROOT}/exp_6_iql_team_reward_variants_qmix_shared_${timestamp}_seed${SEED}"

        ...
        while global_step < args.total_timesteps:
            ...
            while not done and global_step < args.total_timesteps:
                ...
                if global_step - last_eval_step >= args.eval_freq:
                    ...
                    print(f"[QPLEX] Eval at step {global_step}: mean_reward={mean_eval_reward:.3f} std={std_eval_reward:.3f}")
            ...
            if episode % args.log_interval == 0:
                print(f"[QPLEX] episode={episode} steps={global_step} reward_sum={episode_reward_sum:.3f} eps={epsilon:.3f}")
            episode += 1

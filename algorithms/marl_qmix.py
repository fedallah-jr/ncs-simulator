...
from utils.marl import MARLReplayBuffer, QMIXLearner, MLPAgent, QMixer, run_evaluation
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--optimizer", type=str, default="rmsprop", choices=["adam", "rmsprop"], help="Optimizer (rmsprop matches PyMARL).")
        ...
        while global_step < args.total_timesteps:
            ...
            while not done and global_step < args.total_timesteps:
                ...
                if global_step - last_eval_step >= args.eval_freq:
                    ...
                    print(f"[QMIX] Eval at step {global_step}: mean_reward={mean_eval_reward:.3f} std={std_eval_reward:.3f}")

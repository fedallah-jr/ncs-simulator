...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--total-timesteps", type=int, default=250_000, help="Total training timesteps.")
    parser.add_argument("--episode-length", type=int, default=1000, help="Episode length.")
    parser.add_argument("--seed", type=int, default=None, help="Random seed.")
    parser.add_argument("--learning-rate", type=float, default=5e-4, help="PPO learning rate.")

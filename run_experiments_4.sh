...
# MARL experiment batch 4: Independent agents + Double-Q
# vdn_doubleq_independent, qmix_doubleq_independent
...
run_root="${OUTPUT_ROOT}/exp_4_doubleq_independent_${timestamp}_seed${SEED}"

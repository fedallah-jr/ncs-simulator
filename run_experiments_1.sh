...
# MARL experiment batch 1: QPLEX double-q independent agents
# qplex_doubleq_independent
...
run_root="${OUTPUT_ROOT}/exp_1_qplex_doubleq_independent_${timestamp}_seed${SEED}"

...
def save_qlearning_checkpoint(
    ...
    agent_activation: str, dueling: bool,
...
def save_dial_checkpoint(
    path: Path, n_agents: int, obs_dim: int, n_actions: int,
    use_agent_id: bool, agent_hidden_dims: List[int],
    agent_activation: str, agent: torch.nn.Module,
    obs_normalizer: Optional["RunningObsNormalizer"],
    comm_dim: int, dru_sigma: float,
    feature_norm: bool = False, layer_norm: bool = False,
    dueling: bool = False, stream_hidden_dim: Optional[int] = None,
) -> None:
    ckpt: Dict[str, Any] = {
        "algorithm": "iql_dial", "n_agents": n_agents, "obs_dim": obs_dim,
        "n_actions": n_actions, "use_agent_id": use_agent_id,
        ...
        "dial": True, "comm_dim": comm_dim, "dru_sigma": dru_sigma,

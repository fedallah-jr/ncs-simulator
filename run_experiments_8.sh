...
# MARL experiment batch 8: QMIX independent variants
# qmix_independent, qmix_doubleq_independent, qmix_dueling_independent, qmix_dueling_doubleq_independent
...
run_root="${OUTPUT_ROOT}/exp_8_qmix_independent_variants_${timestamp}_seed${SEED}"
...
run_one "algorithms.marl_qmix" "qmix" "qmix_independent" \
  --independent-agents --epsilon-decay-steps "${EPS_DECAY_STEPS}"
run_one "algorithms.marl_qmix" "qmix" "qmix_doubleq_independent" \
